package sukkiri.practice.practice_print02.practice09_a;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (num >= 0 && num <= 2) { //(num == 0 || num == 1 || num ==2)
			...
			if (((num - num_pc) + 3) % 3 == 2) { 	   //(num == 0 && num_pc == 1) || (num == 1 && num_pc == 2) || (num == 2 && num_pc == 0)
				System.out.println("あなたの勝ちです");
			} else if (((num - num_pc) + 3) % 3 == 1) {//(num == 0 && num_pc == 2) || (num == 1 && num_pc == 0) || (num == 2 && num_pc == 1)
